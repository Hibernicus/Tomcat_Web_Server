...
MyXMLReader xReader = new MyXMLReader();
	xReader.elemList("ICT", "iLevel", lev, "i_topic", top, "i_tag", tag);
...
<pre>ICT Resource Number: <%= i+1%>	
Resource Name:	<%=xReader.vars.get(i).getResName()%>	
Resource Type:	<%=xReader.vars.get(i).getResExt()%>	
<FORM ACTION = /opener METHOD = POST>
<input type="text" name="filePath" value = "<%=xReader.vars.get(i).getResPath()%>"  >
<INPUT TYPE = SUBMIT value = "Open Resource" >
</FORM>
