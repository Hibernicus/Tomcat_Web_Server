...
<pre>ICT Resource Number: <%= i+1%>	Resource Name:	<%=xReader.vars.get(i).getResName()%>	Resource Type:	<%=xReader.vars.get(i).getResExt()%>	<a href = "<%=xReader.vars.get(i).getResPath()%>">Open Resource</a> </pre>
