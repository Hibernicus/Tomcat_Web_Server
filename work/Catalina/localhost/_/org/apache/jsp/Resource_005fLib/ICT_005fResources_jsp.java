...
public final class ICT_005fResources_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(int i = 0; i < xReader.vars.size(); i++){
      ...
      out.write("\r\n");
      out.write("<pre>ICT Resource Number: ");
      out.print( i+1);
      out.write("\t\r\n");
...
try{xReader.vars.get(i).english_tags.remove("All");}
 ...
 try{xReader.vars.get(i).user_tags.remove("All");}
      ...
      out.write("           </TD>\r\n");
      out.write("\t   <TD width = 33%>\r\n");
      out.write("\t\t<b>Functional Skills:</b>\r\n");
      out.write("\t\t");
